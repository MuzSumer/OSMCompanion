...
public class ItemizedOverlayControlView extends LinearLayout {
    ...
    public ItemizedOverlayControlView(final Context context,
        ...
        this.mPreviousButton
                .setImageDrawable(context.getResources().getDrawable(R.drawable.nav_previous));

        this.mNextButton = new ImageButton(context);
        this.mNextButton.setImageDrawable(context.getResources().getDrawable(R.drawable.nav_next));

        this.mCenterToButton = new ImageButton(context);
        this.mCenterToButton.setImageDrawable(context.getResources().getDrawable(R.drawable.nav_center));
